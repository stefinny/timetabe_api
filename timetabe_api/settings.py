"""
Django settings for timetabe_api project.
...
SECRET_KEY = 'w9yc+b@(t$7$)!s7a!#@f24@^zs60&off@a(geb++zkva=)yic'
...
ROOT_URLCONF = 'timetabe_api.urls'
...
WSGI_APPLICATION = 'timetabe_api.wsgi.application'
